...
int main()
{
    ...
    while(seguir=='s')
    {
        ...
        printf("11. mostrar listaEmpleados\n");
        ...
        switch(opcion)
        {
            case 1:
                ...
                //ultimoId = parserAlumno("data.csv",listaEmpleados);
            ...
            case 2:
                ...
                break;
            case 3:
                //alumnos_sort(listaEmpleados, 1);
                al_sort(listaEmpleados,alumno_compare,1);
               break;
            case 4:
                alumnos_add(listaEmpleados, ultimoId);
                ultimoId++;
                //
                break;
            case 5:
                 alumno_delete(listaEmpleados);

               break;
            case 6:
                subempleados= al_newArrayList();
                subempleados=al_subList(listaEmpleados,50,63);
                alumnos_print_all(subempleados);

                break;
            case 7:
               alumnos_guardar_all(listaEmpleados, ultimoId);
               alumnos_guardar_binario(listaEmpleados, ultimoId);
                break;
            case 8:
   ...
   printf("LISTA\n");
    ...
    aux = (Alumno*)al_get(listaEmpleados, i);//apunta
    ...
    al_sort(listaEmpleados,alumno_compare,1);//0 descendente
  ...
  for (int i=0; i<al_len(subempleados); i++)
    ...
    aux = (Alumno*)al_get(subempleados, i);//apunta
